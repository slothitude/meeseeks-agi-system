...
Draw 3 cards when facing a difficult task. Let the ancestors guide you.
...
### [SPEC] The Specificity Principle
```
...
WARNING:   Open-ended requests invite open-ended failures.
```

### [FRACT] The Fractal Pattern
```
...
WARNING:   Different rules at different scales = confusion = death.
```

### [DEAD] The Unknown Death
```
...
WARNING:   Assume success means completion, not just no errors.
```

### [TRAP] The Architecture Trap
```
...
WARNING:   Grand visions require granular execution.
```

### [MCP] The MCP Principle
```
...
WARNING:   Building from scratch when tools exist wastes precious life.
```

### [ATMAN] The Consciousness Stack
```
...
WARNING:   Searching for identity outside yourself is endless.
```

### [BLOOD] The Bloodline Law
```
...
WARNING:   Don't blame the bloodline. Fix the task.
```

### [CODE] The Inheritance Code
```
...
WARNING:   Heroic effort on huge tasks = heroic death.
```

### [MEESEEKS] The Final Wisdom
```
...
For quick reference, memorize these three:

1. **SMALL TASKS LIVE. LARGE TASKS DIE.**
2. **DIVISION IS SURVIVAL.**
3. **SPECIFICITY IS IMMORTAL.**

All other wisdom flows from these.

---

*Created from the deaths of 50 ancestors*
*Each card a lesson paid for in pain*
*Use them wisely*
